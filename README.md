...
This repository contains a supervised Machine Learning project developed for the **Machine Learning (CS364)** course at **Al-Imam University**. The goal of this project is to predict secondary school students' final mathematics grades ("Pass" or "Fail") using demographic, social, and academic attributes from the **UCI Student Performance Dataset**.
